...
class OrderController {
    ...
    public function __construct($site = 'admin') {
        ...
        $page = 'orders';
        $pageTitle = 'Daftar Pesanan - Foody Catering';
...
// Redirect ke invoice / WhatsApp
header("Location: $waLink");            header('Location: index.php?page=orders');
        } else {            $clients = $this->clientRepo->getAll();
            $menus = $this->menuRepo->getAll();
            $page = 'orders';
            $pageTitle = 'Tambah Pesanan - Foody Catering';
...
// Methods for public website
    ...
    public function success() {
        ...
        $page = 'order';
        $pageTitle = 'Order Confirmed - Foody Catering';
