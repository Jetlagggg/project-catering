...
class MenuController {
    ...
    public function __construct($site = 'admin') {
        ...
        if ($this->site === 'admin') {
            ...
            $pageTitle = 'Daftar Menu - Foody Catering Admin';
    ...
    public function create() {
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            $page = 'menus';
            $pageTitle = 'Tambah Menu - Foody Catering';
    ...
    public function delete($id) {
        ...
        if ($this->site === 'admin') {
            // Tampilkan halaman admin
            $page = 'foods';
            $pageTitle = 'Foods Menu - Foody Catering Admin';
            $contentView = BASE_PATH . '/views/admin/menus/menu_list_content.php';
            include BASE_PATH . '/views/admin/template.php';
        } else {
            // Tampilkan halaman publik
            $page = 'foods';
            $pageTitle = 'Our Foods - Foody Catering';
