...
<head>
    ...
    <title><?= $pageTitle ?? 'Family 88 - Premium Catering Service' ?></title>    <link rel="stylesheet" href="/TubesYos/assets/style.css">
    ...
    <footer class="public-footer">
        <div class="footer-container">            <div class="footer-info">
          ...
          <div class="footer-bottom">
            <p>&copy; <?= date('Y') ?> Family 88. Hak Cipta Dilindungi.</p>
